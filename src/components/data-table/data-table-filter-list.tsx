...
import type {DataTableAdvancedFilterField, Filter, FilterOperator, JoinOperator, StringKeyOf,} from "@/types"
            ...
            case "number":
                return (
                    <Input
                        ...
                        placeholder={filterField.placeholder ?? "Insira um valor..."}
                    ...
                    {filters.length > 0 ? (
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Adicione filtros para refinar suas resultados.
                            </p>
                        </div>
                    )}
